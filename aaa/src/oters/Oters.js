...
import oterButton from './oterButton';
import './oters.scss';
...
function Oters(){
  ...
  <div className='App'>
    ...
    <h2>합 : {num}</h2>
      <div>
      <button onClick={minus} className='buttons' text='빼기'>빼기</button>
      <button onClick={plus} id='leftButton' className='buttons' text='더하기'>더하기</button>
      </div>
    </div>
    <hr/>
    <select onChange={(e)=>{
